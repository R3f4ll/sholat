...
def update():
      ...
      sp.call(['cd .. && git clone https://github.com/R3f4ll/sholat'],shell=True, stdout=sp.DEVNULL,stderr=sp.STDOUT)
...
{lg}Nama        : {lw}Sholat
{lg}Versi       : {lw}1.0 
{lg}Tanggal     : {lw}19 February 2020
{lg}Author      : {lw}Mr.R3f4ll
{lg}Tujuan      : {lw}Mengingatkan kita pada
              waktu sholat
{lg}Terimakasih : {lw}Allah SWT dan semua
